                ...
                <div class="rightColumnStatic">
                    ...
                    <div class="projectMetadata">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <SharePoint:FieldLabel runat="server" FieldName="GtPlanner" />
                                </td>
                                <td class="fieldValue">
                                    <SharePoint:UserField FieldName="GtPlanner" ControlMode="Display" runat="server" />
                                </td>
                            </tr>
                            <tr class="ms-HoverBackground-bgColor">
                                <td>
                        ...
                        <SharePoint:SPSecurityTrimmedControl runat="server" AuthenticationRestrictions="AuthenticatedUsersOnly" Permissions="AddAndCustomizePages" PermissionContext="CurrentItem">
                            ...
                            <a id="editPageMetaLink" class="ms-navedit-editLinksText" href="#"><span class="ms-navedit-editLinksIconWrapper ms-verticalAlignMiddle">
                                <img class="ms-navedit-editLinksIcon" src="/_layouts/15/images/spcommon.png?rev=23"></span>Rediger egenskapene over</a>
